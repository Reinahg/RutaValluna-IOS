...
//    
//    // variables
//    var authorization : GTMSessionFetcherAuthorizer?
...
//    func saveState(auth: GTMSessionFetcherAuthorizer?) {
...
//    }
//    
//    func handleAuthorizationChanged(auth: GTMSessionFetcherAuthorizer?){
//        authorization = auth
//        saveState(auth: auth)
