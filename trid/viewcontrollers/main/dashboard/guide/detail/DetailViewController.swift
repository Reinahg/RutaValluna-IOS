...
class DetailViewController: DashboardBaseViewController {
    ...
    // Local Lable
    @IBOutlet weak var lblOpeningDay: UILabel!
    ...
    override func viewDidLoad()
    {
        ...
        // Local
        labelDescriptionTitle.text = Localized.Description
        lblOpeningDay.text = Localized.OpeningDay
        lblOpeningTime.text = Localized.OpeningTime
        btnWriteComment.setTitle(Localized.writeCommentBtn, for: .normal)
